...
var asyncToGenerator = require('./asyncToGenerator-17957667.cjs.prod.js');
var sharedKernel = require('@lens-protocol/shared-kernel');
var environments_dist_lensProtocolGatedContentEnvironments = require('./environments-c272b060.cjs.prod.js');
var wallet = require('@ethersproject/wallet');
var raw = require('@lens-protocol/metadata');
...
function assertSupportedChainId(chainID) {
  if (environments_dist_lensProtocolGatedContentEnvironments.isSupportedChainId(chainID)) return;
...
var toLitSupportedChainName = function toLitSupportedChainName(chainId) {
  switch (chainId) {
    case environments_dist_lensProtocolGatedContentEnvironments.SupportedChainId.ETHEREUM:
      return environments_dist_lensProtocolGatedContentEnvironments.SupportedChains.ETHEREUM;
    case environments_dist_lensProtocolGatedContentEnvironments.SupportedChainId.POLYGON:
      return environments_dist_lensProtocolGatedContentEnvironments.SupportedChains.POLYGON;
    case environments_dist_lensProtocolGatedContentEnvironments.SupportedChainId.MUMBAI:
      return environments_dist_lensProtocolGatedContentEnvironments.SupportedChains.MUMBAI;
    case environments_dist_lensProtocolGatedContentEnvironments.SupportedChainId.LINEA_GOERLI:
      return environments_dist_lensProtocolGatedContentEnvironments.SupportedChains.LINEA_GOERLI;
    default:
...
var resolveScalarOperatorSymbol = function resolveScalarOperatorSymbol(operator) {
  if (operator in environments_dist_lensProtocolGatedContentEnvironments.LitScalarOperator) return environments_dist_lensProtocolGatedContentEnvironments.LitScalarOperator[operator];
...
var transformAdvancedContractCondition = function transformAdvancedContractCondition(condition) {
  ...
  return [{
    conditionType: environments_dist_lensProtocolGatedContentEnvironments.LitConditionType.EVM_CONTRACT,
...
var transformCollectCondition = function transformCollectCondition(condition, accessControlContract, context) {
  ...
  return [{
    ...
    functionName: environments_dist_lensProtocolGatedContentEnvironments.LitKnownMethods.HAS_COLLECTED,
    functionParams: [environments_dist_lensProtocolGatedContentEnvironments.LitKnownParams.USER_ADDRESS, bignumber.BigNumber.from(publisherId).toString(), bignumber.BigNumber.from(publicationId).toString(), (_context$profileId = context === null || context === void 0 ? void 0 : context.profileId) !== null && _context$profileId !== void 0 ? _context$profileId : bignumber.BigNumber.from(0).toString(), '0x'],
    functionAbi: {
      constant: true,
      inputs: [{
      ...
      name: environments_dist_lensProtocolGatedContentEnvironments.LitKnownMethods.HAS_COLLECTED,
      outputs: [{
        internalType: 'bool',
        name: '',
        type: 'bool'
    ...
    returnValueTest: {
      key: '',
      comparator: environments_dist_lensProtocolGatedContentEnvironments.LitScalarOperator.EQUAL,
      value: 'true'
    }
  }];
};
...
var transformEoaCondition = function transformEoaCondition(condition) {
  ...
  return [{
    conditionType: environments_dist_lensProtocolGatedContentEnvironments.LitConditionType.EVM_BASIC,
    contractAddress: '',
    // this is intentional, its how lit implements checking for EOA ownership
    standardContractType: '',
    // same as above
    chain: environments_dist_lensProtocolGatedContentEnvironments.SupportedChains.POLYGON,
    method: '',
    // same here
    parameters: [environments_dist_lensProtocolGatedContentEnvironments.LitKnownParams.USER_ADDRESS],
    returnValueTest: {
      comparator: environments_dist_lensProtocolGatedContentEnvironments.LitScalarOperator.EQUAL,
...
var transformErc20Condition = function transformErc20Condition(condition) {
  ...
  return [{
    ...
    standardContractType: environments_dist_lensProtocolGatedContentEnvironments.LitContractType.ERC20,
    chain: toLitSupportedChainName(condition.amount.asset.contract.chainId),
    method: environments_dist_lensProtocolGatedContentEnvironments.LitKnownMethods.BALANCE_OF,
    parameters: [environments_dist_lensProtocolGatedContentEnvironments.LitKnownParams.USER_ADDRESS],
    returnValueTest: {
...
var transformFollowCondition = function transformFollowCondition(condition, accessControlContract) {
  ...
  return [{
    ...
    contractAddress: accessControlContract.address,
    chain: toLitSupportedChainName(accessControlContract.chainId),
    functionName: environments_dist_lensProtocolGatedContentEnvironments.LitKnownMethods.IS_FOLLOWING,
    functionParams: [environments_dist_lensProtocolGatedContentEnvironments.LitKnownParams.USER_ADDRESS, bignumber.BigNumber.from(condition.follow).toString(), bignumber.BigNumber.from(0).toString(), '0x'],
    functionAbi: {
      constant: true,
      inputs: [{
        internalType: 'address',
      ...
      name: environments_dist_lensProtocolGatedContentEnvironments.LitKnownMethods.IS_FOLLOWING,
      outputs: [{
        internalType: 'bool',
        name: '',
        type: 'bool'
...
var _handleOwnsAtLeastOneNftFromCollection = function _handleOwnsAtLeastOneNftFromCollection() {
  return {
    ...
    parameters: [environments_dist_lensProtocolGatedContentEnvironments.LitKnownParams.USER_ADDRESS],
    returnValueTest: {
      comparator: environments_dist_lensProtocolGatedContentEnvironments.LitScalarOperator.GREATER_THAN,
      value: environments_dist_lensProtocolGatedContentEnvironments.LitKnownParams.ZERO
    }
  };
};
var _handleOwnsOneSpecificNftFromCollection = function _handleOwnsOneSpecificNftFromCollection(tokenId) {
  return {
    method: environments_dist_lensProtocolGatedContentEnvironments.LitKnownMethods.OWNER_OF,
    parameters: [tokenId],
    returnValueTest: {
      comparator: environments_dist_lensProtocolGatedContentEnvironments.LitScalarOperator.EQUAL,
      value: environments_dist_lensProtocolGatedContentEnvironments.LitKnownParams.USER_ADDRESS
    }
  };
};
var _handleOwnsOneSpecificNftFromERC1155Collection = function _handleOwnsOneSpecificNftFromERC1155Collection(tokenId) {
  return {
    method: environments_dist_lensProtocolGatedContentEnvironments.LitKnownMethods.BALANCE_OF,
    parameters: [environments_dist_lensProtocolGatedContentEnvironments.LitKnownParams.USER_ADDRESS, tokenId],
    returnValueTest: {
      comparator: environments_dist_lensProtocolGatedContentEnvironments.LitScalarOperator.GREATER_THAN,
      value: environments_dist_lensProtocolGatedContentEnvironments.LitKnownParams.ZERO
    }
...
var _handleOwnsMultipleFromERC1155Collection = function _handleOwnsMultipleFromERC1155Collection(tokenIds) {
  return {
    method: environments_dist_lensProtocolGatedContentEnvironments.LitKnownMethods.BALANCE_OF_BATCH,
    parameters: [tokenIds.map(function () {
      return environments_dist_lensProtocolGatedContentEnvironments.LitKnownParams.USER_ADDRESS;
    }).join(','), tokenIds.join(',')],
    returnValueTest: {
      comparator: environments_dist_lensProtocolGatedContentEnvironments.LitScalarOperator.GREATER_THAN,
      value: environments_dist_lensProtocolGatedContentEnvironments.LitKnownParams.ZERO
...
var transformNftCondition = function transformNftCondition(condition) {
  ...
  var result = {
    conditionType: environments_dist_lensProtocolGatedContentEnvironments.LitConditionType.EVM_BASIC,
    contractAddress: condition.contract.address.toLowerCase(),
    standardContractType: environments_dist_lensProtocolGatedContentEnvironments.LitContractType[condition.contractType],
    chain: toLitSupportedChainName(condition.contract.chainId)
  };
    ...
    case raw.NftContractType.ERC721:
      ...
      if (!condition.tokenIds || condition.tokenIds.length === 0) {
        ...
        return insertObjectInBetweenArrayElements(results, {
          operator: environments_dist_lensProtocolGatedContentEnvironments.LitOperatorType.OR
        });
      }
      break;
...
var transformProfileCondition = function transformProfileCondition(condition, accessControlContract) {
  ...
  return [{
    ...
    contractAddress: accessControlContract.address,
    chain: toLitSupportedChainName(accessControlContract.chainId),
    functionName: environments_dist_lensProtocolGatedContentEnvironments.LitKnownMethods.HAS_ACCESS,
    functionParams: [environments_dist_lensProtocolGatedContentEnvironments.LitKnownParams.USER_ADDRESS, bignumber.BigNumber.from(condition.profileId).toString(), '0x'],
    functionAbi: {
      constant: true,
      inputs: [{
        internalType: 'address',
  ...
  if (condition.type === raw__namespace.ConditionType.AND || condition.type === raw__namespace.ConditionType.OR) {
    ...
    try {
      ...
      return insertObjectInBetweenArrayElements(flat, {
        operator: environments_dist_lensProtocolGatedContentEnvironments.LitOperatorType[condition.type]
      });
    } catch (err) {
...
function createAuthStorage(storageProvider, namespace) {
  var authSigSchema = new storage.BaseStorageSchema("lens.".concat(namespace, ".gated"), AuthSigData);
  return storage.Storage.createForSchema(authSigSchema, storageProvider);
}

var _ToEncryptPaths;
var ToEncryptPaths = (_ToEncryptPaths = {}, asyncToGenerator._defineProperty(asyncToGenerator._defineProperty(asyncToGenerator._defineProperty(asyncToGenerator._defineProperty(asyncToGenerator._defineProperty(asyncToGenerator._defineProperty(asyncToGenerator._defineProperty(asyncToGenerator._defineProperty(asyncToGenerator._defineProperty(asyncToGenerator._defineProperty(_ToEncryptPaths, raw__namespace.PublicationSchemaId.ARTICLE_LATEST, ['lens.content', 'lens.attachments[n].item', 'lens.attachments[n].altTag', 'lens.attachments[n].cover', 'lens.attachments[n].credits', 'lens.attachments[n].artist', 'lens.attachments[n].genre', 'lens.attachments[n].recordLabel', 'lens.attachments[n].lyrics']), raw__namespace.PublicationSchemaId.AUDIO_LATEST, ['lens.content', 'lens.audio.item', 'lens.audio.cover', 'lens.audio.credits', 'lens.audio.artist', 'lens.audio.genre', 'lens.audio.recordLabel', 'lens.audio.lyrics', 'lens.attachments[n].item', 'lens.attachments[n].altTag', 'lens.attachments[n].cover', 'lens.attachments[n].credits', 'lens.attachments[n].artist', 'lens.attachments[n].genre', 'lens.attachments[n].recordLabel', 'lens.attachments[n].lyrics']), raw__namespace.PublicationSchemaId.CHECKING_IN_LATEST, ['lens.content', 'lens.location', 'lens.address.country', 'lens.address.formatted', 'lens.address.locality', 'lens.address.postalCode', 'lens.address.region', 'lens.address.streetAddress', 'lens.position', 'lens.attachments[n].item', 'lens.attachments[n].altTag', 'lens.attachments[n].cover', 'lens.attachments[n].credits', 'lens.attachments[n].artist', 'lens.attachments[n].genre', 'lens.attachments[n].recordLabel', 'lens.attachments[n].lyrics']), raw__namespace.PublicationSchemaId.EMBED_LATEST, ['lens.content', 'lens.embed', 'lens.attachments[n].item', 'lens.attachments[n].altTag', 'lens.attachments[n].cover', 'lens.attachments[n].credits', 'lens.attachments[n].artist', 'lens.attachments[n].genre', 'lens.attachments[n].recordLabel', 'lens.attachments[n].lyrics']), raw__namespace.PublicationSchemaId.EVENT_LATEST, ['lens.content', 'lens.location', 'lens.address.country', 'lens.address.formatted', 'lens.address.locality', 'lens.address.postalCode', 'lens.address.region', 'lens.address.streetAddress', 'lens.position', 'lens.startsAt', 'lens.endsAt', 'lens.links[n]', 'lens.attachments[n].item', 'lens.attachments[n].altTag', 'lens.attachments[n].cover', 'lens.attachments[n].credits', 'lens.attachments[n].artist', 'lens.attachments[n].genre', 'lens.attachments[n].recordLabel', 'lens.attachments[n].lyrics']), raw__namespace.PublicationSchemaId.IMAGE_LATEST, ['lens.content', 'lens.image.item', 'lens.image.altTag', 'lens.attachments[n].item', 'lens.attachments[n].altTag', 'lens.attachments[n].cover', 'lens.attachments[n].credits', 'lens.attachments[n].artist', 'lens.attachments[n].genre', 'lens.attachments[n].recordLabel', 'lens.attachments[n].lyrics']), raw__namespace.PublicationSchemaId.LINK_LATEST, ['lens.content', 'lens.sharingLink', 'lens.attachments[n].item', 'lens.attachments[n].altTag', 'lens.attachments[n].cover', 'lens.attachments[n].credits', 'lens.attachments[n].artist', 'lens.attachments[n].genre', 'lens.attachments[n].recordLabel', 'lens.attachments[n].lyrics']), raw__namespace.PublicationSchemaId.LIVESTREAM_LATEST, ['lens.content', 'lens.startsAt', 'lens.endsAt', 'lens.playbackUrl', 'lens.liveUrl', 'lens.checkLiveAPI', 'lens.attachments[n].item', 'lens.attachments[n].altTag', 'lens.attachments[n].cover', 'lens.attachments[n].credits', 'lens.attachments[n].artist', 'lens.attachments[n].genre', 'lens.attachments[n].recordLabel', 'lens.attachments[n].lyrics']), raw__namespace.PublicationSchemaId.MINT_LATEST, ['lens.content', 'lens.mintLink', 'lens.attachments[n].item', 'lens.attachments[n].altTag', 'lens.attachments[n].cover', 'lens.attachments[n].credits', 'lens.attachments[n].artist', 'lens.attachments[n].genre', 'lens.attachments[n].recordLabel', 'lens.attachments[n].lyrics']), raw__namespace.PublicationSchemaId.SPACE_LATEST, ['lens.content', 'lens.link', 'lens.startsAt', 'lens.attachments[n].item', 'lens.attachments[n].altTag', 'lens.attachments[n].cover', 'lens.attachments[n].credits', 'lens.attachments[n].artist', 'lens.attachments[n].genre', 'lens.attachments[n].recordLabel', 'lens.attachments[n].lyrics']), asyncToGenerator._defineProperty(asyncToGenerator._defineProperty(asyncToGenerator._defineProperty(asyncToGenerator._defineProperty(asyncToGenerator._defineProperty(_ToEncryptPaths, raw__namespace.PublicationSchemaId.STORY_LATEST, ['lens.content', 'lens.asset.item', 'lens.asset.altTag', 'lens.asset.cover', 'lens.asset.credits', 'lens.asset.artist', 'lens.asset.genre', 'lens.asset.recordLabel', 'lens.asset.lyrics']), raw__namespace.PublicationSchemaId.TEXT_ONLY_LATEST, ['lens.content']), raw__namespace.PublicationSchemaId.THREE_D_LATEST, ['lens.content', 'lens.assets[n].uri', 'lens.assets[n].playerUrl', 'lens.attachments[n].item', 'lens.attachments[n].altTag', 'lens.attachments[n].cover', 'lens.attachments[n].credits', 'lens.attachments[n].artist', 'lens.attachments[n].genre', 'lens.attachments[n].recordLabel', 'lens.attachments[n].lyrics']), raw__namespace.PublicationSchemaId.TRANSACTION_LATEST, ['lens.content', 'lens.txHash', 'lens.attachments[n].item', 'lens.attachments[n].altTag', 'lens.attachments[n].cover', 'lens.attachments[n].credits', 'lens.attachments[n].artist', 'lens.attachments[n].genre', 'lens.attachments[n].recordLabel', 'lens.attachments[n].lyrics']), raw__namespace.PublicationSchemaId.VIDEO_LATEST, ['lens.content', 'lens.video.item', 'lens.video.altTag', 'lens.video.cover', 'lens.attachments[n].item', 'lens.attachments[n].altTag', 'lens.attachments[n].cover', 'lens.attachments[n].credits', 'lens.attachments[n].artist', 'lens.attachments[n].genre', 'lens.attachments[n].recordLabel', 'lens.attachments[n].lyrics']));
...
exports.SupportedChains = environments_dist_lensProtocolGatedContentEnvironments.SupportedChains;
exports.development = environments_dist_lensProtocolGatedContentEnvironments.development;
exports.production = environments_dist_lensProtocolGatedContentEnvironments.production;
