...
var BroadcastingError = /*#__PURE__*/function (_CausedError) {
  createSuper._inherits(BroadcastingError, _CausedError);
  var _super = createSuper._createSuper(BroadcastingError);
  function BroadcastingError(reason) {
    ...
    wrapNativeSuper._defineProperty(createSuper._assertThisInitialized(_this), "name", 'BroadcastingError');
    _this.reason = reason;
    return _this;
  }
...
var TokenAllowance = /*#__PURE__*/function (_PaidTransaction) {
  createSuper._inherits(TokenAllowance, _PaidTransaction);
  var _super = createSuper._createSuper(TokenAllowance);
