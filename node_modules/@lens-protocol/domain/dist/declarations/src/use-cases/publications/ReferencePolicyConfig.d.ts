...
export declare enum ReferencePolicyType {
    UNKNOWN = "UNKNOWN",
...
export type ReferencePolicyConfig = FollowersOnlyReferencePolicyConfig | DegreesOfSeparationReferencePolicyConfig | NoReferencePolicyConfig | AnyoneReferencePolicyConfig;
