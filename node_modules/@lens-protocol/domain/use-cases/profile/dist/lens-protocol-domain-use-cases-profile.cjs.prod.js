...
var SponsorshipReady = require('../../../dist/SponsorshipReady-9c9573b3.cjs.prod.js');
...
var ToggleProperty = require('../../../dist/ToggleProperty-a1db47a4.cjs.prod.js');

var BlockProfiles = /*#__PURE__*/function (_SponsorshipReady) {
  createSuper._inherits(BlockProfiles, _SponsorshipReady);
  var _super = createSuper._createSuper(BlockProfiles);
...
var ClaimHandleError = /*#__PURE__*/function (_Error) {
  createSuper._inherits(ClaimHandleError, _Error);
  var _super = createSuper._createSuper(ClaimHandleError);
  function ClaimHandleError(localName, reason) {
    var _this;
    createClass._classCallCheck(this, ClaimHandleError);
    _this = _super.call(this, "Cannot claim\"".concat(localName, "\" because: ").concat(reason));
    wrapNativeSuper._defineProperty(createSuper._assertThisInitialized(_this), "name", 'ClaimHandleError');
...
var FollowProfile = /*#__PURE__*/function (_SponsorshipReady) {
  createSuper._inherits(FollowProfile, _SponsorshipReady);
  var _super = createSuper._createSuper(FollowProfile);
...
var LinkHandle = /*#__PURE__*/function (_SponsorshipReady) {
  createSuper._inherits(LinkHandle, _SponsorshipReady);
  var _super = createSuper._createSuper(LinkHandle);
...
var SetProfileMetadata = /*#__PURE__*/function (_SponsorshipReady) {
  createSuper._inherits(SetProfileMetadata, _SponsorshipReady);
  var _super = createSuper._createSuper(SetProfileMetadata);
...
var ToggleProfileProperty = ToggleProperty.ToggleProperty;

var UnblockProfiles = /*#__PURE__*/function (_SponsorshipReady) {
  createSuper._inherits(UnblockProfiles, _SponsorshipReady);
  var _super = createSuper._createSuper(UnblockProfiles);
...
var UnfollowProfile = /*#__PURE__*/function (_SponsorshipReady) {
  createSuper._inherits(UnfollowProfile, _SponsorshipReady);
  var _super = createSuper._createSuper(UnfollowProfile);
...
var UnlinkHandle = /*#__PURE__*/function (_SponsorshipReady) {
  createSuper._inherits(UnlinkHandle, _SponsorshipReady);
  var _super = createSuper._createSuper(UnlinkHandle);
...
var UpdateFollowPolicy = /*#__PURE__*/function (_SponsorshipReady) {
  createSuper._inherits(UpdateFollowPolicy, _SponsorshipReady);
  var _super = createSuper._createSuper(UpdateFollowPolicy);
...
var UpdateProfileManagers = /*#__PURE__*/function (_SponsorshipReady) {
  createSuper._inherits(UpdateProfileManagers, _SponsorshipReady);
  var _super = createSuper._createSuper(UpdateProfileManagers);
...
exports.ToggleProfileProperty = ToggleProfileProperty;
