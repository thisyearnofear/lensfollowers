...
var WalletAlreadyInvitedError = /*#__PURE__*/function (_Error) {
  createSuper._inherits(WalletAlreadyInvitedError, _Error);
  var _super = createSuper._createSuper(WalletAlreadyInvitedError);
  function WalletAlreadyInvitedError(invalid) {
    ...
    wrapNativeSuper._defineProperty(createSuper._assertThisInitialized(_this), "name", 'WalletAlreadyInvitedError');
...
var InsufficientAllowanceError = /*#__PURE__*/function (_Error) {
  createSuper._inherits(InsufficientAllowanceError, _Error);
  var _super = createSuper._createSuper(InsufficientAllowanceError);
  function InsufficientAllowanceError(requestedAmount) {
    ...
    wrapNativeSuper._defineProperty(createSuper._assertThisInitialized(_this), "name", 'InsufficientAllowanceError');
...
var InsufficientFundsError = /*#__PURE__*/function (_Error2) {
  createSuper._inherits(InsufficientFundsError, _Error2);
  var _super2 = createSuper._createSuper(InsufficientFundsError);
  function InsufficientFundsError(requestedAmount) {
    ...
    wrapNativeSuper._defineProperty(createSuper._assertThisInitialized(_this2), "name", 'InsufficientFundsError');
