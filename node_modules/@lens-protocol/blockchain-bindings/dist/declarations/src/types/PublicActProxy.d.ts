...
export interface PublicActProxyInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: 'incrementNonce' | 'name' | 'nonces' | 'publicCollect' | 'publicCollectWithSig' | 'publicFreeAct'): FunctionFragment;
    encodeFunctionData(functionFragment: 'incrementNonce', values: [PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: 'name', values?: undefined): string;
    encodeFunctionData(functionFragment: 'nonces', values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: 'publicCollect', values: [Types.PublicationActionParamsStruct]): string;
    encodeFunctionData(functionFragment: 'publicCollectWithSig', values: [Types.PublicationActionParamsStruct, Types.EIP712SignatureStruct]): string;
    encodeFunctionData(functionFragment: 'publicFreeAct', values: [Types.PublicationActionParamsStruct]): string;
...
export interface PublicActProxy extends BaseContract {
    ...
    functions: {
        incrementNonce(increment: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        name(overrides?: CallOverrides): Promise<[string]>;
        nonces(signer: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>;
        publicCollect(publicationActionParams: Types.PublicationActionParamsStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        publicCollectWithSig(publicationActionParams: Types.PublicationActionParamsStruct, signature: Types.EIP712SignatureStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        publicFreeAct(publicationActionParams: Types.PublicationActionParamsStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    incrementNonce(increment: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
    ...
    callStatic: {
        incrementNonce(increment: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        name(overrides?: CallOverrides): Promise<string>;
        nonces(signer: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        publicCollect(publicationActionParams: Types.PublicationActionParamsStruct, overrides?: CallOverrides): Promise<void>;
        publicCollectWithSig(publicationActionParams: Types.PublicationActionParamsStruct, signature: Types.EIP712SignatureStruct, overrides?: CallOverrides): Promise<void>;
        publicFreeAct(publicationActionParams: Types.PublicationActionParamsStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        incrementNonce(increment: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
