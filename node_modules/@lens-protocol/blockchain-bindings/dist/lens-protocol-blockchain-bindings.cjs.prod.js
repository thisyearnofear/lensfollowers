...
var lensTokenHandleRegistryAbi = [
	{
		inputs: [
			{
				internalType: "address",
...
function lensFollowNFT(address, provider) {
  return new contracts.Contract(address, lensFollowNftAbi, provider);
}
function lensHub(address, provider) {
  return new contracts.Contract(address, lensHubAbi, provider);
}
function lensTokenHandleRegistry(address, provider) {
  return new contracts.Contract(address, lensTokenHandleRegistryAbi, provider);
}
...
exports.lensFollowNFT = lensFollowNFT;
exports.lensHub = lensHub;
exports.lensTokenHandleRegistry = lensTokenHandleRegistry;
