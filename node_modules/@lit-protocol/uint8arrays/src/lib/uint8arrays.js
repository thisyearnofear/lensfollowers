...
var Uint8arrays = (() => {
    ...
    var j = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports), d = (t, e) => {
        jt(t);
        for (var r in e)
            Me(t, r, { get: e[r], enumerable: !0 });
    };
    var Oe = j((ee) => {
        'use strict';
    ...
    function Ut(t, e) {
        ...
        for (var o = 0; o < t.length; o++) {
            var n = t.charAt(o), i = n.charCodeAt(0);
            if (r[i] !== 255)
                throw new TypeError(n + ' is ambiguous');
            r[i] = o;
        }
        var c = t.length, f = t.charAt(0), L = Math.log(c) / Math.log(256), b = Math.log(256) / Math.log(c);
        function q(u) {
            ...
            for (var y = ((w - C) * b + 1) >>> 0, l = new Uint8Array(y); C !== w;) {
                for (var x = u[C], F = 0, E = y - 1; (x !== 0 || F < M) && E !== -1; E--, F++)
                    (x += (256 * l[E]) >>> 0), (l[E] = x % c >>> 0), (x = (x / c) >>> 0);
                if (x !== 0)
                    throw new Error('Non-zero carry');
                (M = F), C++;
            }
            for (var A = y - M; A !== y && l[A] === 0;)
                A++;
            for (var J = f.repeat(p); A < y; ++A)
                J += t.charAt(l[A]);
            return J;
        }
        function R(u) {
            ...
            var p = 0;
            if (u[p] !== ' ') {
                for (var M = 0, C = 0; u[p] === f;)
                    M++, p++;
                for (var w = ((u.length - p) * L + 1) >>> 0, y = new Uint8Array(w); u[p];) {
    ...
    var Pe, Ot, It, se, m, Lt, oe, ne, S = D(() => {
        (Pe = new Uint8Array(0)),
            (Ot = (t) => t.reduce((e, r) => e + r.toString(16).padStart(2, '0'), '')),
            (It = (t) => {
                let e = t.match(/../g);
    ...
    var Te, Ve, ke, $e, _e, N, B, qt, Nt, a, g = D(() => {
        Ne();
        S();
        (Te = class {
            constructor(e, r, s) {
            ...
            (N = ({ name: t, prefix: e, encode: r, decode: s }) => new _e(t, e, r, s)),
            ...
            (qt = (t, e, r, s) => {
                ...
                for (; t[n - 1] === '=';)
                    --n;
                let i = new Uint8Array(((n * r) / 8) | 0), c = 0, f = 0, L = 0;
                for (let b = 0; b < n; ++b) {
                    let q = o[t[b]];
                    if (q === void 0)
            ...
            (Nt = (t, e, r) => {
                let s = e[e.length - 1] === '=', o = (1 << r) - 1, n = '', i = 0, c = 0;
            ...
            (a = ({ name: t, prefix: e, bitsPerChar: r, alphabet: s }) => N({
                prefix: e,
                name: t,
                encode(o) {
                    return Nt(o, s, r);
    ...
    var P, Rt, Jt, Xt, Gt, Kt, Qt, Ht, Wt, he = D(() => {
        g();
        (P = a({
            prefix: 'b',
            name: 'base32',
    ...
    function Ce(t, e) {
        var r = 0, e = e || 0, s = 0, o = e, n, i = t.length;
        do {
            if (o >= i)
    ...
    var cr, Ye, dr, hr, fr, pr, br, tt, lr, mr, Cr, Er, gr, wr, yr, xr, vr, Ar, jr, Fr, k, rt = D(() => {
    ...
    var U, Ee, ge, V, $ = D(() => {
        ...
        K();
        (U = (t, e) => {
            let r = e.byteLength, s = I(t), o = s + I(r), n = new Uint8Array(o + r);
            return O(t, n, 0), O(r, n, s), n.set(e, o), new V(t, r, e, n);
        }),
            (Ee = (t) => {
                let e = m(t), [r, s] = T(e), [o, n] = T(e.subarray(s)), i = e.subarray(s + n);
                if (i.byteLength !== o)
    ...
    var h, _r, Rr, Jr, _, Xr, ct, dt, Z, Y, Gr, Kr, Qr, ht = D(() => {
        K();
        $();
        be();
        he();
        ...
        (h = class {
            ...
            toV1() {
                switch (this.version) {
                    case 0: {
                        let { code: e, digest: r } = this.multihash, s = U(e, r);
            ...
            static asCID(e) {
                ...
                if (e != null && e.asCID === e) {
                    ...
                    let { version: r, multihash: s, code: o } = e, n = Ee(s);
            ...
            static create(e, r, s) {
                ...
                switch (e) {
                    case 0: {
                        if (r !== _)
                            throw new Error(`Version 0 CID must use dag-pb (code: ${_}) block encoding`);
            ...
            static decodeFirst(e) {
                let r = h.inspectBytes(e), s = r.size - r.multihashSize, o = m(e.subarray(s, s + r.multihashSize));
                if (o.byteLength !== r.multihashSize)
                    throw new Error('Incorrect length');
                let n = o.subarray(r.multihashSize - r.digestSize), i = new V(r.multihashCode, r.digestSize, n, o);
                return [
            ...
            static inspectBytes(e) {
                ...
                if ((o === 18 ? ((o = 0), (r = 0)) : o === 1 && (n = s()),
                    o !== 0 && o !== 1))
                    throw new RangeError(`Invalid CID version ${o}`);
                let i = r, c = s(), f = s(), L = r + f, b = L - i;
                return {
                    version: o,
                    codec: n,
                    multihashCode: c,
            ...
            (Xr = 18),
            (ct = (t, e, r) => {
                let s = I(t), o = s + I(e), n = new Uint8Array(o + r.byteLength);
    ...
    var Se = j((Qs, Et) => {
        ...
        var Ct = mt('utf8', 'u', (t) => {
            ...
            return 'u' + e.decode(t);
        }, (t) => new TextEncoder().encode(t.substring(1))), Fe = mt('ascii', 'a', (t) => {
            let e = 'a';
    ...
    var xt = j((z) => {
        ...
        var ns = Oe(), us = Ie(), Ds = Le(), is = gt(), as = wt(), cs = yt();
