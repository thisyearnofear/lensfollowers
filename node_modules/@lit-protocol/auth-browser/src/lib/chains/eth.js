...
// @ts-ignore
const lit_connect_modal_1 = require("lit-connect-modal");
...
if ((0, misc_1.isBrowser)()) {
    // @ts-ignore
    globalThis.WalletConnectProviderPkg = ethereum_provider_1.default;
    (0, misc_1.log)('WalletConnectProviderPkg:', ethereum_provider_1.default);
}
var WALLET_ERROR;
...
const chainHexIdToChainName = (chainHexId) => {
    ...
    if (!chainHexId.startsWith('0x')) {
        (0, misc_1.throwError)({
            ...
            error: constants_1.LIT_ERROR.WRONG_PARAM_FORMAT,
        });
    }
    ...
    if (!hexIds.includes(chainHexId)) {
        (0, misc_1.throwError)({
            ...
            error: constants_1.LIT_ERROR.UNSUPPORTED_CHAIN_EXCEPTION,
        });
    }
    // -- search
...
const getChainId = async (chain, web3) => {
    ...
    try {
        ...
        resultOrError = (0, constants_1.ELeft)({
            ...
            error: constants_1.LIT_ERROR.WRONG_NETWORK_EXCEPTION,
        });
    }
 ...
 */
const connectWeb3 = async ({ chainId = 1, }) => {
 ...
 * @returns
 */
const checkAndSignEVMAuthMessage = async ({ chain, resources, switchChain, expiration, uri, }) => {
    // -- check if it's nodejs
    if ((0, misc_1.isNode)()) {
    ...
    const _signAndGetAuth = async ({ web3, account, chainId, resources, expiration, uri, }) => {
        ...
        if (authSigOrError.type === 'ERROR') {
            (0, misc_1.throwError)({
                ...
                error: constants_1.LIT_ERROR.LOCAL_STORAGE_ITEM_NOT_FOUND_EXCEPTION,
            });
        }
