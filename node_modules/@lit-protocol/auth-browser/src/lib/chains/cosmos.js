 ...
 */
const connectCosmosProvider = async ({ chain, }) => {
 ...
 * @returns { AuthSig }
 */
const checkAndSignCosmosAuthMessage = async ({ chain, }) => {
    const connectedCosmosProvider = await (0, exports.connectCosmosProvider)({ chain });
