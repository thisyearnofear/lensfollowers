 ...
 * @returns { boolean }
 */
export declare const getMustResign: (authSig: JsonAuthSig, resources: any) => boolean;
/**
 *
 ...
 */
export declare const connectWeb3: ({ chainId, }: ConnectWeb3) => Promise<ConnectWeb3Result>;
/**
 * @browserOnly
 ...
 * @returns
 */
export declare const checkAndSignEVMAuthMessage: ({ chain, resources, switchChain, expiration, uri, }: CheckAndSignAuthParams) => Promise<JsonAuthSig>;
/**
 * @browserOnly
 ...
 * @returns { JsonAuthSig }
 */
export declare const signAndSaveAuthMessage: ({ web3, account, chainId, resources, expiration, uri, }: signAndSaveAuthParams) => Promise<JsonAuthSig>;
/**
 * @browserOnly
 * Sign Messags
 *
